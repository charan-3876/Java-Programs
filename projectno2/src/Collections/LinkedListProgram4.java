...
public class LinkedListProgram4 
{
  public static void main(String[] args)
  {
	  ...
	  do
	  {
		  ...
		  {
			 System.out.println("Enter double element: ");
		     l2.add(scan.nextDouble());
		  }
		  else if(choice==3)
		  {
			 System.out.println("Enter char element: ");
		     l2.add(scan.next().charAt(0));
		  }
		  else if(choice==4)
		  {
			 System.out.println("Enter boolean element: ");
		     l2.add(scan.nextBoolean());
		  }
		  else if(choice==5)
		  {
			 System.out.println("Enter string element: ");
	  ...
	  boolean status=l1.containsAll(l2);
	  if(status==true)
	  {
		  System.out.println("LinkedList elements are same.....");  
	  }
	  else
	  {
		  System.out.println("LinkedList elements are not same....");
	  }
  }
}
